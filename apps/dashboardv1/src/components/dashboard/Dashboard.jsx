...
const deadlines = [
  {
    ...
    subject: 'Mathematics',
    title: 'Advanced Calculus - Quiz 3',
    due: 'Thursday, Oct 24 • 11:59 PM',
  },
  {
    id: 2,
    icon: 'lab_research',
  ...
  },
  {
    ...
    subject: 'History',
    title: 'Modern World History Essay',
    due: 'Monday, Oct 28 • 11:59 PM',
  },
];

const courses = [
  { label: 'Mathematics', modules: '12 of 15 Modules Completed', percent: 85, offset: 15 },
  { label: 'Science',     modules: '8 of 13 Modules Completed',  percent: 62, offset: 38 },
  { label: 'History',     modules: '22 of 24 Modules Completed', percent: 92, offset: 8  },
];

const submissions = [
  { subject: 'Applied Physics',   title: 'Final Lab Report',   grade: 'A-' },
  { subject: 'Ethics 101',        title: 'Weekly Reflection',  grade: 'A+' },
  { subject: 'Macro Economics',   title: 'Midterm Exam',       grade: 'B+' },
];
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Eduflux student dashboard — view deadlines, course progress, and recent grades." />
        <link
      ...
      <div className="flex h-screen overflow-hidden bg-background-light dark:bg-background-dark text-[#120f1a] dark:text-white font-display">
        ...
        <main className="flex-1 flex flex-col overflow-y-auto">
          ...
          {/* Top Navigation */}
          <TopNav userName="Alex Johnson" studentId="2024883" />
          ...
          <div className="p-6 lg:p-10 space-y-8 max-w-[1400px] mx-auto w-full">
            ...
            <div className="relative overflow-hidden bg-primary rounded-xl p-8 text-white shadow-lg shadow-primary/20">
              <div className="relative z-10">
                ...
                <p className="text-white/80 text-lg font-light max-w-xl">
                  You have 4 assignments due this week. Stay on top of your Organic Chemistry lab report!
                </p>
                <div className="mt-6 flex flex-wrap gap-4">
                  <div className="bg-white/20 backdrop-blur-md rounded-lg px-4 py-2 border border-white/10">
                    <p className="text-xs uppercase font-bold tracking-wider opacity-70">Next Class</p>
                    <p className="text-sm font-medium">9:30 AM – World History</p>
                  </div>
                  <div className="bg-white/20 backdrop-blur-md rounded-lg px-4 py-2 border border-white/10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              {/* Course Progress (1/3) */}
              <div className="space-y-4">
                <h3 className="text-xl font-bold px-2">Course Progress</h3>
            ...
            {/* ── Recent Submissions ── */}
            <div className="space-y-4">
              <h3 className="text-xl font-bold px-2">Recent Submissions</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="bg-white dark:bg-white/5 border-2 border-dashed border-[#ebe9f2] dark:border-white/10 rounded-xl p-4 flex flex-col items-center justify-center opacity-60 hover:opacity-90 transition-opacity cursor-pointer">
                  <span className="material-symbols-outlined text-3xl mb-1">visibility</span>
                  <p className="text-xs font-bold">View History</p>
                </div>
              </div>
            </div>
