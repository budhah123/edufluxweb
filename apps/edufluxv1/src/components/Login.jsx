...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data?.accessToken) storage.setItem('auth_token', data.accessToken);
              ...
              <form className="px-10 pb-10 space-y-5" onSubmit={handleSubmit} noValidate>
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex justify-between items-center">
                    ...
                    <Link href="/forgot-password" className="text-xs font-semibold text-gray-500 hover:text-primary transition-colors">
                      Forgot Password?
                    </Link>
                  </div>
